// FONTIFY ULTIMATE - THE ULTIMATE FONT LIBRARY (COMPLETE & FIXED)

const fontLibrary = [
    // --- PURANE FONTS JO PEHLE SE MOJOOD THAY ---
    ...
    { name: 'Bold', category: 'Basic', map: { a: '𝗮', b: '𝗯', c: '𝗰', d: '𝗱', e: '𝗲', f: '𝗳', g: '𝗴', h: '𝗵', i: '𝗶', j: '𝗷', k: '𝗸', l: '𝗹', m: '𝗺', n: '𝗻', o: '𝗼', p: '𝗽', q: '𝗾', r: '𝗿', s: '𝘀', t: '𝘁', u: '𝘂', v: '𝘃', w: '𝘄', x: '𝘅', y: '𝘆', z: '𝘇' } },
    { name: 'Italic', category: 'Basic', map: { a: '𝘢', b: '𝘣', c: '𝘤', d: '𝘥', e: '𝘦', f: '𝘧', g: '𝘨', h: '𝘩', i: '𝘪', j: '𝘫', k: '𝘬', l: '𝘭', m: '𝘮', n: '𝘯', o: '𝘰', p: '𝘱', q: '𝘲', r: '𝘳', s: '𝘴', t: '𝘵', u: '𝘶', v: '𝘷', w: '𝘸', x: '𝘹', y: '𝘺', z: '𝘻' } },
    { name: 'Bubbles', category: 'Cute', map: { a: 'ⓐ', b: 'ⓑ', c: 'ⓒ', d: 'ⓓ', e: 'ⓔ', f: 'ⓕ', g: 'ⓖ', h: 'ⓗ', i: 'ⓘ', j: 'ⓙ', k: 'ⓚ', l: 'ⓛ', m: 'ⓜ', n: 'ⓝ', o: 'ⓞ', p: 'ⓟ', q: 'ⓠ', r: 'ⓡ', s: 'ⓢ', t: 'ⓣ', u: 'ⓤ', v: 'ⓥ', w: 'ⓦ', x: 'ⓧ', y: 'ⓨ', z: 'ⓩ' } },
    { name: 'Squares', category: 'Boxed', map: { a: '🄰', b: '🄱', c: '🄲', d: '🄳', e: '🄴', f: '🄵', g: '🄶', h: '🄷', i: '🄸', j: '𝔍', k: '🄺', l: '🄻', m: '🄼', n: '🄽', o: '🄾', p: '🄿', q: '🅀', r: '🅁', s: '🅂', t: '🅃', u: '🅄', v: '🅅', w: '🅆', x: '🅇', y: '🅈', z: '🅉' } },
    ...
    // --- FILE 6: ASIAN & INTERNATIONAL STYLES ---
    { name: 'Japanese Style', category: 'Special', transform: (text) => '【' + text + '】' },
    { name: 'Chinese Style', category: 'Special', map: { a: '卂', b: '乃', c: '匚', d: '刀', e: '乇', f: '下', g: '厶', h: '卄', i: '工', j: '丁', k: '长', l: '乚', m: '从', n: 'ん', o: '口', p: '尸', q: '㔿', r: '尺', s: '丂', t: '丅', u: '凵', v: 'リ', w: '山', x: '乂', y: '丫', z: '乙' } },
    { name: 'Russian Style', category: 'Special', map: { a: 'Д', b: 'Б', c: 'C', d: 'D', e: 'Ё', f: 'F', g: 'G', h: 'H', i: 'Ї', j: 'J', k: 'K', l: 'L', m: 'M', n: 'Й', o: 'Ф', p: 'P', q: 'Q', r: 'Я', s: 'S', t: 'T', u: 'Ц', v: 'V', w: 'W', x: 'X', y: 'У', z: 'Z' } },

    // --- FILE 7: FUN & WEIRD STYLES ---
    { name: 'Mirrored', category: 'Fun', transform: (text) => text + text.split('').reverse().join('') },

    // --- FILE 8: CLASSIC & BASIC STYLES ---
    ...
    // --- FILE 10: SPECIAL LINES & UNDERLINES ---
    { name: 'Double Strikethrough', category: 'Basic', transform: (text) => text.split('').map(c => c + '\u0336' + '\u0336').join('') },
    { name: 'Double Underline', category: 'Basic', transform: (text) => text.split('').map(c => c + '\u0333').join('') },
    { name: 'Dotted Underline', category: 'Basic', transform: (text) => text.split('').map(c => c + '\u0324').join('') }
];
